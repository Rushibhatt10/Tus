    ...
    <div className={`min-h-screen flex items-center justify-center py-12 px-4 ${bgClass}`}>
      <div className={`w-full max-w-md p-8 md:p-10 ${cardClass} backdrop-blur-lg shadow-2xl rounded-2xl space-y-8`}>
        ...
        <button
          ...
          disabled={loading}
          className={`w-full flex items-center justify-center gap-3 py-4 border rounded-xl font-medium ${isDark ? "text-white border-gray-700 bg-gray-800 hover:bg-gray-700" : "text-black border-gray-300 bg-white hover:bg-gray-50"} transition-all mt-4`}
        >
          <img
