    ...
    <>
      ...
      <div className="bg-gray-50 border-b border-gray-100 py-2 text-center">
        <p className="text-sm text-gray-600">
          Get up to ₹750 OFF at checkout • Shop more, save more! • Free delivery all over India
        </p>
      </div>
      ...
      <nav className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-gray-100 z-50">
            ...
            <div className="hidden md:flex items-center flex-1 max-w-md mx-8">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 w-full"
                />
              </div>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100">
            <div className="px-4 py-4 flex space-x-6">
